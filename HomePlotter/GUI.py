...
# This class initializes all GUI components, handles callbacks, and begins the TKinter loop
class GUI(object):
    window: tk.Tk
    canvas: tk.Canvas
    nameList: tk.Listbox
    ...
    # Initialize GUI components. Create window, create and add widgets
    def init():
        PointManager.init()
    ...
    # Main GUI loop. When called, will run TKinter window loop
    def loop():
        GUI.window.mainloop()
    ...
    # Set input boxes data based on a specified SaePoint
    ...
    # Logic ran upon a point selection
